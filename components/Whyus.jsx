                ...
                <div className="container max-w-5xl mx-auto m-8">
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-5/6 sm:w-1/2 p-6">
                            ...
                            <p className="text-gray-600 mb-8">
                                Kami mendukung pembayaran automatis melalui: <br />
                                1. QRIS (QR Code) dan OVO <br />
                                2. Credit Card<br />
                                3. BCA KlikPay<br />
                                4. Retail (Alfamart/Pos Indonesia/Pegadaian)<br />
                                5. Virtual Account (BRI/BNI/Mandiri)
                            </p>
                        </div>
                        <div className="w-full sm:w-1/2 p-6">
                            <img className="w-full sm:h-40 mx-auto" src="/img/undraw_online_payments.svg"
                                alt="Online Payments" />
                        </div>
                    </div>
